...
<head>
    ...
    <style>
        ...
        .sidebar-item.active { 
            background: linear-gradient(135deg, #1DBF92 0%, #158b6a 100%);
            color: white; 
...
<body class="text-gray-800 flex min-h-screen">
    <aside class="fixed inset-y-0 left-0 z-40 w-72 bg-white border-r border-gray-100 flex flex-col p-8 shadow-2xl shadow-school-blue/5">
        <div class="flex items-center space-x-4 mb-16">
            <div class="w-12 h-12 bg-school-teal rounded-[1.2rem] flex items-center justify-center shadow-xl shadow-school-teal/20">
                <i data-lucide="home" class="text-white w-7 h-7"></i>
            </div>
            <div>
        ...
        <nav class="flex-1 space-y-3">
            ...
            <a href="#" class="sidebar-item group flex items-center space-x-4 p-4 rounded-[1.5rem] text-gray-400 hover:text-school-blue hover:bg-school-blue/5 transition-all">
    ...
    <main class="flex-1 lg:ml-72 p-10">
        <header class="flex justify-between items-center mb-16">
            <div>
                <h2 class="text-3xl font-black text-school-blue tracking-tighter uppercase">Welcome, <?= explode(' ', $_SESSION['name'])[0] ?></h2>
                <p class="text-[10px] text-gray-400 font-black uppercase tracking-[0.3em] mt-1">Parent Portal | Tracking Academic Excellence</p>
            </div>
            <div class="w-14 h-14 rounded-[1.5rem] bg-school-teal/10 p-1 border-2 border-school-teal/10 flex items-center justify-center text-school-teal">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div class="glass-card rounded-[4rem] p-12">
                <div class="flex items-center justify-between mb-10">
                    <h3 class="text-2xl font-black text-school-blue tracking-tighter uppercase">Student Progress</h3>
                    <div class="p-4 bg-school-blue/5 text-school-blue rounded-2xl"><i data-lucide="trending-up" class="w-6 h-6"></i></div>
                </div>
                <div class="space-y-8">
                    <div class="p-8 bg-gray-50/50 rounded-[2.5rem] border border-gray-100">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <span class="px-5 py-2 bg-school-teal text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg shadow-school-teal/20">Grade: A</span>
                        </div>
                        <div class="w-full bg-gray-200/50 h-3 rounded-full overflow-hidden mb-3">
                            <div class="bg-school-teal h-full w-[85%] rounded-full shadow-[0_0_10px_rgba(29,191,146,0.5)]"></div>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Attendance</span>
                            <span class="text-[10px] text-school-teal font-black uppercase tracking-widest">96% Status</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-10">
                <div class="bg-school-blue rounded-[4rem] p-12 text-white shadow-2xl shadow-school-blue/30 relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <button class="mt-10 px-10 py-5 bg-white text-school-blue rounded-[1.5rem] font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-xl">Secure Online Payment</button>
                    </div>
                ...
                <div class="glass-card rounded-[4rem] p-12">
                    <div class="flex items-center justify-between mb-8">
                        <h3 class="text-xl font-black text-school-blue tracking-tighter uppercase">Notice Board</h3>
