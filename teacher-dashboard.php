...
<head>
    ...
    <style>
        ...
        .glass-card:hover { 
            ...
            box-shadow: 0 40px 80px -20px rgba(139, 92, 246, 0.1);
        }
    </style>
</head>
<body class="text-gray-800 flex min-h-screen">
    <aside class="fixed inset-y-0 left-0 z-40 w-72 bg-white border-r border-gray-100 flex flex-col p-8 shadow-2xl shadow-school-purple/5">
        <div class="flex items-center space-x-4 mb-16">
            ...
            <div>
                <h1 class="text-2xl font-black text-school-purple tracking-tighter">FACULTY</h1>
    ...
    <main class="flex-1 lg:ml-72 p-10">
        <header class="flex justify-between items-center mb-16">
            ...
            <div class="flex items-center space-x-6">
                <div class="text-right">
                    <p class="text-sm font-black text-school-purple uppercase tracking-widest"><?= $_SESSION['name'] ?></p>
                    <p class="text-[9px] font-black text-school-orange uppercase tracking-widest mt-1">Senior Faculty Staff</p>
                </div>
                <div class="w-14 h-14 rounded-[1.5rem] bg-school-purple/5 p-1 border-2 border-school-purple/10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div class="glass-card p-10 rounded-[4rem]">
                <div class="p-4 bg-school-purple/10 text-school-purple w-fit rounded-2xl mb-8"><i data-lucide="users" class="w-7 h-7"></i></div>
                <h4 class="text-gray-400 font-black text-[10px] uppercase tracking-widest">Total Students</h4>
                <p class="text-4xl font-black text-school-purple mt-2"><?= $totalStudents ?></p>
            </div>
            <div class="glass-card p-10 rounded-[4rem]">
                <div class="p-4 bg-school-orange/10 text-school-orange w-fit rounded-2xl mb-8"><i data-lucide="book-open" class="w-7 h-7"></i></div>
                <h4 class="text-gray-400 font-black text-[10px] uppercase tracking-widest">Active Classes</h4>
                <p class="text-4xl font-black text-school-purple mt-2">4 <span class="text-lg text-gray-300 ml-1">Sections</span></p>
            </div>
            <div class="glass-card p-10 rounded-[4rem]">
                <div class="p-4 bg-green-50 text-green-500 w-fit rounded-2xl mb-8"><i data-lucide="calendar-check-2" class="w-7 h-7"></i></div>
                <h4 class="text-gray-400 font-black text-[10px] uppercase tracking-widest">Daily Attendance</h4>
                <p class="text-4xl font-black text-green-500 mt-2"><?= $attendanceRate ?>% <span class="text-lg text-gray-300 ml-1">Rate</span></p>
            </div>
            <div class="bg-school-purple p-10 rounded-[4rem] text-white shadow-2xl shadow-school-purple/30 border-none relative overflow-hidden">
        ...
        <div class="glass-card p-12 rounded-[4rem]">
            <div class="flex items-center justify-between mb-10">
                ...
                <span class="px-6 py-2 bg-school-purple/5 text-school-purple text-[10px] font-black uppercase tracking-widest rounded-full">Term 2 • 2026</span>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex items-center justify-between p-8 bg-gray-50/50 rounded-[2.5rem] border border-gray-100 group hover:bg-white hover:shadow-xl transition-all duration-500">
                    <div class="flex items-center space-x-6">
                        <div class="w-14 h-14 bg-white rounded-2xl shadow-sm text-school-purple flex items-center justify-center group-hover:bg-school-purple group-hover:text-white transition-all"><i data-lucide="calendar" class="w-6 h-6"></i></div>
                        <div>
                            <p class="text-lg font-black text-school-purple">Mathematics Midterm</p>
                            <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1">May 15, 2026 • Form 3A</p>
                        </div>
                    </div>
                    <span class="px-5 py-2 bg-school-orange text-white rounded-full text-[9px] font-black uppercase tracking-widest shadow-lg shadow-school-orange/20">Active</span>
                </div>
                <div class="flex items-center justify-between p-8 bg-gray-50/50 rounded-[2.5rem] border border-gray-100 group hover:bg-white hover:shadow-xl transition-all duration-500">
                    <div class="flex items-center space-x-6">
                        <div class="w-14 h-14 bg-white rounded-2xl shadow-sm text-school-purple flex items-center justify-center group-hover:bg-school-purple group-hover:text-white transition-all"><i data-lucide="calendar" class="w-6 h-6"></i></div>
                        <div>
                            <p class="text-lg font-black text-school-purple">Physics Practical</p>
                            <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1">May 18, 2026 • Form 4B</p>
                        </div>
                    </div>
                    <span class="px-5 py-2 bg-yellow-400 text-white rounded-full text-[9px] font-black uppercase tracking-widest shadow-lg shadow-yellow-400/20">Drafting</span>
                </div>
            </div>
        </div>
    </main>
